...
const Select = ({
    ...
    return(
        ...
        <div className={`${fullWidth ? "w-full" : ""} mb-4 relative`}>
            ...
            <select id={selectId} {...rest} className={`block w-full bg-gray-800 py-4 pl-10 pr-4 rounded-xl text-gray-50 text-sm border ${error ? "border-red-500" : "border-gray-700"}
