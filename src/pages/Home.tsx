                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div >
                            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                                Gerencie suas finanças com <span className="text-primary-500">DevBills</span>
                            </h1>
                ...
                <section className="py-12 md:py-20 bg-gray-900 rounded-xl">
                    <div className="container-app">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-lg text-white mas-w-2xl mx-auto">Nossa plataforma oferece tudo o que você precisa 
                                para manter suas finanças organizadas</p>
                        </div>
