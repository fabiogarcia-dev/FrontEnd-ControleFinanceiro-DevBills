...
const Transactions = () =>{
    ...
    const handleSearchChange = (event: ChangeEvent<HTMLInputElement>): void => {
        ...
        setFilteredTransactions(
            transactions.filter((transaction) => transaction.description.toUpperCase().includes(event.target.value.toUpperCase()),
            ),
        );
    };
    ...
    return(
        <div className="container-app py-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                ...
                <Link to="/transacoes/nova" className="bg-primary-500 text-[#051626] font-semibold px-4 py-2.5 rounded-xl
            ...
            <Card className="overflow-hidden">
                {loading ? (
                    ...
                    <div className="text-center py-12">
                        ...
                        <Link to="/transacoes/nova" className=" w-fit mx-auto mt-6 bg-primary-500 text-[#051626] font-semibold px-4 py-2.5 rounded-xl
                flex items-center justify-center hover:bg-primary-600 transition-all"><Plus className="w-4 h-4 mr-2" />Nova Transação</Link>
                                    ...
                                    <td className="px-3 py-4 text-sm  whitespace-nowrap">
                                     ...
                                     <td className="px-3 py-4 text-sm whitespace-nowrap">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-sm text-gray-400 mr-2">{transaction.category.name}</span>
                                        </div>
                                    </td>
